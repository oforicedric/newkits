...
def scrape(request):
    ...
    url= "https://www.footballwebpages.co.uk/northern-premier-league-premier-division"
    ...
    for i in rows:
        if 'title' in i.attrs:
            ...
            for pic in i.find_all('img'):
                url = "https://www.footballwebpages.co.uk/northern-premier-league-premier-division" + pic.get('data-src') 
